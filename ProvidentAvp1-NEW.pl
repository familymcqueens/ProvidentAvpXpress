...
if ($product eq "GAP")
{
	print HTML_OUTPUT_FILE  "<td width=\"3%\" align=\"center\" bgcolor=\"#F3F781\"><input type=\"radio\" name=\"cust_product\" value=\"GAP\" checked>GAP</td>   ";
	$product_months = 12;
}
else
{
	print HTML_OUTPUT_FILE  "<td width=\"4%\" align=\"center\" bgcolor=\"#F3F781\"><input type=\"radio\" name=\"cust_product\" value=\"Warranty\">Warranty</td><br>\n"; 
	$product_months = 3;
}
...
while (<AM_INPUT_FILE>) 
{
	...
	print HTML_OUTPUT_FILE  "<td width=\"7%\" align=\"center\" bgcolor=\"#04B431\"><label for=\"months\"></label><select id=\"months\" name=\"cust_",$loopIteration,"_product_months\"><option value=\"3\">3</option><option value=\"12\">12</option><option value=\"18\">18</option><option value=\"24\">24</option><option value=\"36\">36</option><option value=\"48\">48</option><option value=\"60 selected\">60</option></select></td>\n";
